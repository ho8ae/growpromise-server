// src/api/sticker/sticker.routes.ts
...
// 스티커 템플릿 라우트
router.get('/templates', stickerController.getAllStickerTemplates);
router.get('/templates/category/:category', stickerController.getStickerTemplatesByCategory);

// 부모 라우트
router.post('/', requireParent, validate(createStickerSchema), stickerController.createSticker);
